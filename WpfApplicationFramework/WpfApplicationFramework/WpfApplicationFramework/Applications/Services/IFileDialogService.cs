...
namespace System.Waf.Applications.Services
{
    ...
    public interface IFileDialogService
    {
        ...
        /// <summary>
        /// Open File with Multi select mode
        /// </summary>
        /// <param name="owner"></param>
        /// <param name="fileTypes"></param>
        /// <param name="defaultFileType"></param>
        /// <param name="defaultFileName"></param>
        /// <param name="aMultiSelect"></param>
        /// <returns></returns>
        FileDialogResult ShowOpenFileDialog(object owner, IEnumerable<FileType> fileTypes, FileType defaultFileType, string defaultFileName, bool aMultiSelect);
